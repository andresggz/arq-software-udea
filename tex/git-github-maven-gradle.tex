...
\begin{thebibliography}{99}
    ...
    %https://dzone.com/articles/gradle-vs-maven#:~:text=Gradle%20is%20based%20on%20a,things%20that%20do%20the%20work.%E2%80%9D
    \bibitem{DZone} H.~Part1: \emph{Germa \TeX}, TUGboat Volume~9, Issue~1(1988) 
    %https://gradle.org/
    \bibitem{Gradle} H.~Part1: \emph{Germa \TeX}, TUGboat Volume~9, Issue~1(1988) 
    %https://maven.apache.org/
    \bibitem{Maven} H.~Part1: \emph{Germa \TeX}, TUGboat Volume~9, Issue~1(1988) 
    %https://en.wikipedia.org/wiki/Apache_Maven
    \bibitem{Apache} H.~Part1: \emph{Germa \TeX}, TUGboat Volume~9, Issue~1(1988) 
\end{thebibliography}

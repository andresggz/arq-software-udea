package co.edu.udea.tdt.component.user.io.gateway;

import co.edu.udea.tdt.component.user.io.repository.UserRepository;
import co.edu.udea.tdt.component.user.model.User;
import co.edu.udea.tdt.component.user.service.UserGateway;

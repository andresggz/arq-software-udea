...
import co.edu.udea.tdt.component.roadmap.service.model.CourseAddCmd;
import co.edu.udea.tdt.component.roadmap.service.model.RoadmapAddedToCareerCmd;
import co.edu.udea.tdt.component.roadmap.service.model.RoadmapQuerySearchCmd;
import co.edu.udea.tdt.component.roadmap.service.model.RoadmapSaveCmd;
...
public class RoadmapServiceImpl implements RoadmapService {
    ...
    private List<Roadmap> extractRoadmapsFromSheets(InputStream inputStreamRoadmaps) {
        ...
        try {
            extractFromWorkbook(inputStreamRoadmaps, roadmapsToCreate);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void extractFromWorkbook(InputStream inputStreamRoadmaps, List<Roadmap> roadmapsToCreate) throws IOException {
